...
class ScenarioRunner:
	...
	def simulate_all_scenarios(self):
		...
		for timeline in timelines_parameters:
			...
			parameter_table.loc['full_automation_requirements_training', 'Conservative'] = parameters[
				'Full automation requirements']
			parameter_table.loc['full_automation_requirements_training', 'Best guess'] = parameters[
				'Full automation requirements']
			parameter_table.loc['full_automation_requirements_training', 'Aggressive'] = parameters[
				'Full automation requirements']
