  ...
  '''))
	...
	for year in years:
		...
		row = {
			...
			'cumulative input hardware': model.cumulative_rnd_input_hardware[index] / model.rnd_input_hardware[
				0] * 0.003048307243707020,
			'ratio rnd input hardware': model.rnd_input_hardware[0] ** model.rnd_parallelization_penalty /
										model.cumulative_rnd_input_hardware[0],
	...
	all_years_container.append(
		et.fromstring('<p>Show funny cell bars <input id="show-cell-bars" type="checkbox"></input></p>'))
